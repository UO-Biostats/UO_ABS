...
author: "Peter Ralph"
date: "16 November 2020 -- Advanced Biological Statistics"
---
...
```{r fit, cache=TRUE, dependson="model"}
fit1 <- sampling(model,
...
```{r plottrace, cache=TRUE, dependson="model"}
...
```{r results, cache=TRUE, dependson="model"}
