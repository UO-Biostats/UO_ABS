...
2. [get the course repository from github](https://uo-biostats.github.io/UO_ABS/pages/using-git.html), and/or
3. move around.
...
*Exercise:* use this code to estimate a $p$-value,
write a conclusion,
and explain why it is a $p$-value by filling in the specifics of the definition.
