...
$$\begin{aligned}
    Y_i &= b_0 + b_1 X_1 + \cdots + b_k X_k + \epsilon_i \\
    \epsilon_i &\sim \Normal(0, \sigma) .
\end{aligned}$$

. . .

The key model component here is the *linear* predictor.
...
$$ \text{data} \sim \text{fit} + \text{predicted} $$
