...
$$\begin{aligned}
    n_{ij} &\sim \Binom(n, p_i p_j) , \\
    \text{where}\quad
    p_i &= (\text{prob of hair color $i$}) \\
    p_j &= (\text{prob of eye color $j$}) .
\end{aligned}$$
...
So,
$$\begin{aligned}
    \sd[n_{ij}] = \sqrt{ n p_i p_j (1 - p_i p_j) } ,
\end{aligned}$$
