...
```
Femur ~ SVL_cm + Sex + Hurricane + Origin + Sex : Hurricane
```
- Should we include a nonlinear relationship with SVL?
- How about different slopes (i.e., interactions of SVL with other factors)?
