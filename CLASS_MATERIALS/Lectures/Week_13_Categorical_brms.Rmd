...
For example, the *proportion of brown-haired people who have blue eyes* is
$$\begin{aligned}
...
We're using a *log link function*, so additivity corresponds to independence:
$$\begin{aligned}
    p_{ij}
    &=
        \frac{
...
(What do we mean: given sex? averaged across sex?)
